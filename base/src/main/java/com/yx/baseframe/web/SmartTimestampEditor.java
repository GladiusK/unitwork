 ...
 * </pre>
 */
public class SmartTimestampEditor extends PropertyEditorSupport {

	private final List<SimpleDateFormat> dateFormats;
	private final boolean allowEmpty;
	private final int exactDateLength;

	public SmartTimestampEditor(List<SimpleDateFormat> dateFormats, boolean allowEmpty) {
		this.dateFormats = dateFormats;
		this.allowEmpty = allowEmpty;
		this.exactDateLength = -1;
	}

	public SmartTimestampEditor(List<SimpleDateFormat> dateFormats,
