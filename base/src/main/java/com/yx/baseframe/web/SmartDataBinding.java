 ...
 * </pre>
 */
public class SmartDataBinding implements WebBindingInitializer {
	...
	public void initBinder(WebDataBinder binder, WebRequest request) {
		...
		binder.registerCustomEditor(java.util.Date.class, new SmartDateEditor(
				dateFormats, true));
		binder.registerCustomEditor(java.sql.Timestamp.class,
				new SmartTimestampEditor(datetimeFormats, true));
