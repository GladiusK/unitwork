...
public static Date calDay(Date date, int amount) throws Exception{
    ...
    public static Date dateAddition(Date date,String additStr){
            ...
            if("m".equals(strs[0].toString())){//分钟
                    reDate = DateTools.add(date,Calendar.MINUTE,Integer.parseInt(strs[1].toString()));
            }else if("h".equals(strs[0].toString())){//小时
                    reDate =  DateTools.add(date,Calendar.HOUR_OF_DAY,Integer.parseInt(strs[1].toString()));
            }else if("d".equals(strs[0].toString())){//天
                    reDate =  DateTools.add(date,Calendar.DAY_OF_MONTH,Integer.parseInt(strs[1].toString()));
            }
            return reDate;
    }       
